...
public class EncryptedSocketManager extends SocketManager{
	 ...
	 * @see com.mp.utilities.SocketManager#init()
	 */
	public void init() {
		super.init();
	...
	/*
	 * Send information
	 * @see com.mp.utilities.SocketManager#send(byte[], int, java.lang.String)
	 */
	 ...
	 * @see com.mp.utilities.SocketManager#run()
	 */
	public void run() {
		try {
